            ...
            <div class="card-body">
              <form class="form-bordered" id="ajaxForm">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-5" name="title" value="{{$test->title}}">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input-5" name="sub_title" value="{{$test->title}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="input-9" class="col-sm-2 col-form-label">Content</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="4" id="input-9" name="content" >{!! $test->content !!}</textarea>
                  </div>
                </div>
                @if(!empty($test))

<div class="form-group row">
<label for="input-8" class="col-sm-2 col-form-label"></label>
    <div class="col-sm-10" id="ImagePrevsss">
                <img style="width:100px;" src="{{ url('data/pages/'.$test->attachment_url) }}" class="img-circle"/><br>
                <span style="cursor: pointer;" onclick="removeImage({{$test->attachment_id}})">Remove</span>
...
@endif
                ...
                <div class="form-group row">
                  ...
                  <table class="table table-bordered table-hover" style="width:25%;margin-left: 217px;">
                                                <thead>
                ...
                <div class="form-footer">
                    ...
                    <input type="hidden" name="page_id"   value="{{$test->page_id}}" />
                    <input type="hidden" name="type"   value="editAbout"/>
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            setInterval(function(){
                                ...
                                $('#messageModal').modal('show');
                               window.location.href="{{URL::route('AdminAboutList')}}";
                            }, 1500);
