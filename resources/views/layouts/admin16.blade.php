...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="#" class="logo">
            ...
            <span class="logo-lg"><b></b>NetProclivity</span>
        </a>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview">
                            ...
                            <li ><a href="{{ URL::route('Menus') }}"><i class="fa fa-circle-o"></i> Menus </a></li>
                            <li><a href="{{ URL::route('Pages') }}"><i class="fa fa-circle-o"></i> Pages </a></li>
                            <li><a href="{{ URL::route('Banners') }}"><i class="fa fa-circle-o"></i> Banners </a></li>
                            <li><a href="{{ URL::route('AdminTestimonial') }}"><i class="fa fa-circle-o"></i> Testimonials </a></li>
                            <li><a href="{{ URL::route('AdminReview') }}"><i class="fa fa-circle-o"></i> Client Reviews </a></li>
                            <li><a href="{{ URL::route('AdminServicePageEdit',16) }}"><i class="fa fa-circle-o"></i> Service Page </a></li>
                            <li><a href="{{ URL::route('AdminClientPageEdit',18) }}"><i class="fa fa-circle-o"></i> Client Page </a></li>
